...
namespace CivicDataFrontEnd.Web.Models.Helpers
{
    public static class SettingsHelper
    {
        ...
        {
            return ConfigurationManager.AppSettings["Platform.Theme"];
        }
        ...
        {
            string enabled = ConfigurationManager.AppSettings["Platform.BreadcrumbsEnabled"];
        ...
        {
            string enabled = ConfigurationManager.AppSettings["Platform.BreadcrumbsHomeEnabled"];
            return (enabled == "false") ? false : true;
        }
        ...
        {
            return ConfigurationManager.AppSettings["Platform.BreadcrumbsBaseLabel"];
        }
        ...
        {
            return ConfigurationManager.AppSettings["Platform.Organization"];
        }
        ...
        {
            return ConfigurationManager.AppSettings["Platform.PackageTitlePrefix"];
        }
        ...
        public static int GetDatasetTitleLength()
        {
            ...
            string configTitleLength = ConfigurationManager.AppSettings["Platform.DatasetTitleLength"];
            int titleLength = 60;
        ...
        {
            return GetList("Platform.HiddenTags");
        }
